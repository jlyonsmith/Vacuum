...
namespace Vacuum
{
	public class FilterExtension
	{
        ...
        public FilterExtension(IEnumerable<ParsedPath> inputPaths, IEnumerable<ParsedPath> outputPaths)
        {
        ...
        public FilterExtension(IEnumerable<TsonStringNode> inputPaths, IEnumerable<TsonStringNode> outputPaths)
        {
		...
		public FilterExtension(string input, string output)
		{
			Input = input;
			Output = output;
		}
		...
		public override bool Equals(object obj)
		{
			...
			return Equals(obj as FilterExtension);
		}
		
		public bool Equals(FilterExtension other)
		{
			if (other == null)
				return false;
